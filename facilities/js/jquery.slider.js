	...
	$.fn.slider = function (options) {
		...
		return this.each (function(){
			var defaultValue = {
				...
				source: [
							{
								src: '../image/slide/swimming.jpg'									// 骞荤伅鐗囧浘鐗囧湴鍧€

 							},
							{
								src: '../image/slide/swimming2.jpg'									// 骞荤伅鐗囧浘鐗囧湴鍧€

							},
							{
								src: '../image/slide/pool-relaxation.jpg'									// 骞荤伅鐗囧浘鐗囧湴鍧€

							},
							{
								src: '../image/slide/swimming3.jpg',
