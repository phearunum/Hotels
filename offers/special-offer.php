...
<div id="wrapper"  style="width: 1300px;height: auto; ">
    <div class="w3-white" style="width: 100%; height: 545px; background-position: bottom; background-size:cover;
    ...
    <div class="w3-white" style="height:auto;width:1100px;margin-top: 350px;
     margin-left: 100px; text-align: left;">
        ...
        box-shadow:0px 1px 5px #fff;opacity: 0.8">
           ...
           font-family: Calibri;padding-top: 10px; padding-left: 10px; text-transform: uppercase">HOME >>special-offer </div>
    ...
    -webkit-align-content: center;">
            ...
            foreach($res as $output) {
                ...
                <div class=" box w3-hover-them " style="width:520px; background-color:#f7f7f7; height:220px;margin: 5px; margin-top: 20px ;padding: 20px;border-radius:5px 5px 5px 5px; box-shadow: 1px 2px 1px #9C9C9C">
                    ...
                    <p class="w3-hover-text-black" style="text-transform: uppercase; color: goldenrod; margin-top: -5px"> >> <?php echo $output["offerName"]; ?></p>

                    <div class="w3-card w3-border w3-white w3-left" style="width: 220px;padding: 3px;border-radius: 5px; margin-top:10px; " >
                        <img src="../image/offer/<?php echo $output["offerImg"]; ?>" width="100%" height="100%"/>
                    </div>
                    <div class="w3-right " style="height: 130px; width: 250px; margin-top: 10px; font-size: 15px">
                        <ul style="color: #636363">
                            <li> 。Special Room Decoration </li>
                            <li> 。Free Pick Up (One Way Only) </li>
                            <li> 。One Bottle Of Wine  </li>
                            <li style="font-weight: bold"> 。All Inclusive VIP Accommodation </li>
                    ...
                    <?php
                    $secure=new secure();
                    $sll=$secure->encryptIt($output["offerID"]);
                    ?>
                    <a href="/offers/special-offer-view?secure=<?php echo $sll; ?>">
                        <div class="w3-left" style="color:#636363 ; margin-left: 10px; font-weight: bold;font-size: 15px">
                            + Details
                        </div>
                    </a>
                    <a href="https://reservation.travelanium.net/propertyibe2/?propertyId=430&onlineId=4">
                        <div class=" effect6 w3-right botton" style="border-radius: 3px;width: 100px;padding: 5px;color:#464646; font-size: 13px; font-weight: bold;float: right">
                            >> Book Now <<
                        </div>
                    </a>
