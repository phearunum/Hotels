...
<head>
    ...
    <title>Luxury Hotel in Sihanouk Ville | Sihanouk Ville Hotels | Official Site | Sokha Beach Resort</title>
...
<div id="wrapper" style="width: 1300px;height: auto; ">
     ...
     background-color:#FFF; position: absolute; padding-bottom: 5px;box-shadow: 2px 2px 7px 2px #9C9C9C">
        ...
        height:50px;width:100%; background-size: cover; background-position: center; padding: 10px; color: #4e5b6c; font-size: 15px ">
            <form id="booking_form" action=""  >
                <label>* CheckIn: </label>
                <input  name="date_of_arrival" id="date_of_arrival" class="date-picker "  placeholder="Check-in" type="text"
                ...
                <input name="date_of_departure" id="date_of_departure" class="date-picker "  placeholder="Check-out" type="text"
                       style="width: 125px;border:none; border-radius: 4px; background-image: url('/img/bgalert.png'); background-size: cover;height: 25px" />
                <label>* Adults :</label>
                ...
                <input type="submit" value="Check Avialability" id="submit" onclick="fnbooking()" style="background-color:#c55a83; border: 1px solid white; height: 25px;
    ...
    <div id="header">
        ...
        <div class="main-menu" style="width:900px; margin-right:200px" >
            ...
            background-size:cover;padding:0px;height:40px;border-bottom: 2px solid white   ;">
                ...
                <li class=""><a class="menu_item" href="/room/room">  Accommodation</a></li>
    ...
    <div class="" style="height:auto;width:1100px; margin-top: 350px;
     margin-left: 100px; text-align: left; background-color: #f1f1f1">
        <div class="" style="width:100%; background-image: url('../img/bgalert.png');height:40px; background-size: contain; background-size: cover;
       opacity: 0.8">
           <div id="titelfont" style="font-size: 17px; color:deeppink;
           font-family: Calibri;padding-top: 10px; padding-left: 10px; text-transform: uppercase">HOME >> Restaurant & Bar </div>

        </div>
        <div class="w3-container " style="width: 100%; min-height: 500px">
            <br/>
            <duv class="" style="width:100%;height: 200px;float: left; border-radius: 5px;padding: 10px; margin-top: -5px">
                <div class="" style="width: 600px;height: auto;float: left">
                    <h4 style="font-weight: bold"> ABOUT THE RESTAURANT </h4>
                    <p>Nestled in the topmost floor, our restaurant offers a relaxed dining experience with a variety of scrumptious dishes, an extensive array of cocktails, and a spectacular view of the SihanoukVille Skyline.</p><br/>
                </div>
                <div class="" style="float: right; width: 410px;  padding: 5px; border-radius: 5px">
                    <h4  style="font-weight: bold"> RESTAURANT OPERATION </h4>
                    <div class="container" style="margin-top: 10px;">
                        <p >OPERATION <span class=" lotus-icon-time" style="font-size: 20px;"> </span>: 7 days( 6:30 am - 10:00 pm )</p>
                        <ul class="list-group" style="border:none">
                            <li class="list-group-item" >。Buffet Breakfast :  6:30 am - 10:00 am </li>
                            <li class="list-group-item">。Lunch (Set or Buffet ) :  11:00 am - 2:00 pm </li>
                            <li class="list-group-item">。Dinner ( Set or Buffet) : 6: 00 pm - 10:00pm </li>
                        </ul>
                    </div>
                </div>
            </duv>

            <duv class="" style="width:100%;height: 230px;float: left; border-radius: 5px;padding: 10px; margin-top: -5px">
              <div class="" style="width: 700px;height: auto;float: left">
                  <h4 style="font-weight: bold"> BREAKFAST </h4>
                  <p>Start your day with a wide selection of international dishes and local favorites from our breakfast buffet. </p><br/>
              </div>
                <div class="" style="float: right; width: 310px; background-color:white; padding: 5px; border-radius: 5px">
                   <img  src="../image/dinning/breakfast.jpg" width="300" height="200"/>
                </div>
            </duv>

            <duv class="" style="width:100%;height: 230px;float: left; border-radius: 5px;padding: 10px; margin-top: -5px">
                <div style="width: 700px;height: 200px;float: left">
                    <h4 style="font-weight: bold"> LUNCH</h4>
                    <p> Spoil yourself with our seafood menu, including fresh Oysters, Crabs and Prawns served on ice or cooked your way.</p>
                </div>
                <div class="" style="float: right; width: 310px; background-color:white; padding: 5px; border-radius: 5px">
                    <img  src="../image/dinning/lunch.jpg" width="300" height="200"/>
                </div>
            </duv>

            <duv class="" style="width:100%;height: 230px; float: left; border-radius: 5px;padding: 10px; margin-top: -5px">
                <div style="width: 700px;height: auto;float: left">
                <h4 style="font-weight: bold"> DINNER</h4>
                <p>Enjoy a sensational dinner overlooking the Occheuteal Sea. Choose from our fine selection of wines, and toast the majestic Cambodian sunset.</p>
                </div>
                <div class="" style="float: right; width: 310px; background-color:white; padding: 5px; border-radius: 5px">
                    <img  src="../image/dinning/dinner.gif" width="300" height="200"/>
                </div>
            </duv>
...
<br/>
    ...
    <div class="box effect6" style="width: 100%;height: 200px;">
