...
<div class="w3-main w3-container w3-padding-0" style=" margin-left:200px; min-height:600px!important; margin-top: 62px">
    <div class="w3-container  w3-padding " style=" min-height: 600px;">
        <center>   <div style=" font-weight: bold; font-size: 25px; color:darkslateblue">RESERVATION MANAGEMENT </div></center>
        <div class="btn btn-primary btn-sm " style="margin-bottom: 10px;" id="open_form" > Add New Customer </div>
        <div class="w3-container w3-padding  w3-theme form_insert " style="margin-bottom: 20px;" id="form_insert">
            <form class="form-inline" style="margin-top: -5px;" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm"  name="c_id">
                </div>
                <div class="form-group">
                    <p for="pwd">Check In:</p>
                    <input type="date" class="form-control input-sm"   name="c_in" >
                </div>
                <div class="form-group">
                    <p for="pwd">Check Out:</p>
                    <input type="date" class="form-control input-sm"  name="c_out">
                </div>
                <div class="form-group">
                    ...
                    <select name="r_type" class=" form-control input-sm"  >
                        ...
                        if($check_room->num_rows >0){
                            while ($name_room = $check_room->fetch_assoc()){
                                ...
                                ?>
                                <option value="<?php echo $name_room['room_name'] ;?>"><?php echo $name_room['room_name'] ;?></option>
                                <?php
                ...
                <button type="submit" class="btn btn-sm w3-right w3-pink " style="margin-top: 30px;" name="btn_book"><span class="glyphicon glyphicon-floppy-saved"></span>Save</button>
            </form>
            <?php
        ...
        <table class="table table-hover " >
            ...
            $check_room=$conn->query($get_room);
            if($check_room->num_rows >0){
                while ($get_customer = $check_room->fetch_array()){
                    $id_cus=$get_customer['id'];
                    ?>
                    <tr>
                        ...
                        <td>
                            <a href="?delete=<?php echo $id_cus;?>"  class="btn btn-danger btn-sm"style="font-size: 11px;" onclick="return confirm('Are you sure you want to delete? <?php echo $id_cus;?>')"><span class="glyphicon glyphicon-remove"></span>Delete</a>
