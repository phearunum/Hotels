...
<div id="wrapper" style="width: 1300px;height: auto; ">
    ...
    <div class="" style="height:auto;width:1100px; margin-top: 350px;
     margin-left: 100px; text-align: left; background-color: #f1f1f1">
       ...
       opacity: 0.8">
        ...
        <div class="w3-container " style="width: 100%;align-content: ;display: flex; display: -webkit-flex;
    display: flex;
    ...
    -webkit-align-content: center;">
            ...
            $Db =new Database();
            $Db->connect();
            $Db->sql("SELECT * FROM tbl_events");
            $res = $Db->getResult();
            foreach($res as $output) {
                ?>

                <div class=" box w3-hover-them " style="width:520px; background-color:#f7f7f7; height:220px;margin: 5px; margin-top: 20px ;padding: 20px;border-radius:5px 5px 5px 5px; box-shadow: 1px 2px 1px #9C9C9C">

                    <p class="w3-hover-text-black" style="text-transform: uppercase; color: goldenrod; margin-top: -5px"> >> <?php echo $output["ev_title"]; ?></p>

                    <div class="w3-card w3-border w3-white w3-left" style="width: 220px;padding: 3px;border-radius: 5px; margin-top:10px; " >
                        <img src="../image/event/<?php echo $output["ev_img"]; ?>"  onclick="onClick(this)" width="100%" height="100%"/>
                    </div>
                    <div class="w3-right " style="height: 130px; width: 250px; margin-top: 10px; font-size: 15px">
                        <ul style="color: #636363">
                            <h4 style="font-weight: bold">+ <?php echo $output["ev_date"]; ?></h4>
                            <h4 style="margin-left: 5px"><?php echo $output["ev_desc"]; ?></h4>
                    ...
                    <?php
                    $secure=new secure();
                    $sll=$secure->encryptIt($output["ev_id"]);
                    ?>
